 ...
 */
final class Version20240826141722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video_progress_user (video_progress_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_8660D5B061593668 (video_progress_id), INDEX IDX_8660D5B0A76ED395 (user_id), PRIMARY KEY(video_progress_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE video_progress ADD video_id INT NOT NULL, ADD progress DOUBLE PRECISION NOT NULL, ADD last_watched_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video_progress DROP video_id, DROP progress, DROP last_watched_at');
    }
}
